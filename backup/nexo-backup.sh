...
#
# La passphrase SOLO la sabe el usuario. Nunca está en el repositorio.
# ═══════════════════════════════════════════════════════════
...
INCLUDE=(
    ...
    "$NEXO_HOME/config/crontab.example.txt"
...
if [[ "$1" == "--help" ]]; then
    ...
    echo ""
    echo "La passphrase SOLO la sabe el usuario."
